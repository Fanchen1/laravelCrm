...
<div class="layui-form-item">
    <label for="L_email" class="layui-form-label">
        <span class="x-red">*</span>反馈分类
    </label>
    <div class="layui-input-inline">
        <input type="text" id="classify" name="email" required="" lay-verify="email"
...
<script>
    $('#submit').on('click',function(){
        ...
        if(classify == ''){
            layer.msg('反馈分类不能为空',{icon:0});
            return false;
        }

        $.ajax({
            url:'/index.php/aftersaleClassifyDo',
            type:'post',
            data:'classify='+classify+'&_token='+'{{csrf_token()}}',
            dataType:'json',
            async:false,
