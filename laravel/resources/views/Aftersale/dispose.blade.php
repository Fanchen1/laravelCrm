...
<div class="x-body layui-anim layui-anim-up">
    <form class="layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="aftersale_issue" name="aftersale_issue" placeholder="填写反馈主题" value="{{$aftersale['aftersale_issue']}}" disabled
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select name="classify_id" disabled>
                    <option value="0">请选择</option>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" class="layui-input" disabled name="aftersale_time" placeholder="年-月-日" value="{{$aftersale['aftersale_time']}}">
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea placeholder="请输入内容" class="layui-textarea" name="aftersale_contents" disabled>{{$aftersale['aftersale_contents']}}</textarea>
            </div>
        </div>
...
<script>
    ...
    $('[name=add]').on('click',function(){
        ...
        var  data = '';
        if(is_solve == 1){
            data = 'id='+id+'&is_solve='+is_solve+'&_token='+'{{csrf_token()}}';
        }else{
            if(result_time == ''){
            ...
            data ='id='+id+'&is_solve='+is_solve+'&result_time='+result_time+'&result='+result+'&_token='+'{{csrf_token()}}';
        }



        $.ajax({
            url: '/index.php/disposeDo',
            type: 'post',
            data: data,
            dataType: 'json',
            async: false,
