...
<div class="x-body layui-anim layui-anim-up">
    <form class="layui-form">
            ...
            <div class="layui-input-inline" >
                <select name="product_id"  >
                    ...
                    @foreach($product as $v)
                        @if($aftersale['product_id'] == $v['product_id'])
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="aftersale_issue" name="aftersale_issue" placeholder="填写反馈主题" value="{{$aftersale['aftersale_issue']}}"
            ...
            <div class="layui-input-inline">
                <select name="classify_id" >
                    ...
                    @foreach($classify as $v)
                        @if($aftersale['classify_id'] == $v['classify_id'])
                            <option value="{{$v['classify_id']}}" selected>{{$v['aftersale_classify']}}</option>
                        @else
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select name="user_id" >
                    ...
                    @foreach($user_name as $v)
                        @if($aftersale['user_id'] == $v['user_id'])
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" class="layui-input"  name="aftersale_time" placeholder="年-月-日" value="{{$aftersale['aftersale_time']}}">
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea placeholder="请输入内容" class="layui-textarea" name="aftersale_contents" >{{$aftersale['aftersale_contents']}}</textarea>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" id="isis">
                <input type="radio" name="is_solve" value="1" title="未解决" >
                <input type="radio" name="is_solve" value="2" title="已解决" checked="">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" id="result_time" name="result_time"  placeholder="年-月-日" value="{{$aftersale['result_time']}}">
            </div>
        </div><br><br>
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea placeholder="请输入内容" class="layui-textarea" name="result" >{{$aftersale['result']}}</textarea>
            </div>
        </div>
        <input type="hidden" name="id" value="{{$aftersale['aftersale_id']}}">
        <div class="layui-form-item">
...
<script>
    ...
    $('[name=add]').on('click',function(){
        ...
        var  data = '';
        if(is_solve == 1){
            data = 'id='+id+'&product_id='+product_id+'&aftersale_issue='+aftersale_issue+'&classify_id='+classify_id+'&user_id='+user_id+'&aftersale_time='+aftersale_time+'&aftersale_contents='+aftersale_contents+'&is_solve='+is_solve+'&_token='+'{{csrf_token()}}';
        }else{
            if(result_time == ''){
            ...
            data ='id='+id+'&product_id='+product_id+'&aftersale_issue='+aftersale_issue+'&classify_id='+classify_id+'&user_id='+user_id+'&aftersale_time='+aftersale_time+'&aftersale_contents='+aftersale_contents+'&is_solve='+is_solve+'&result_time='+result_time+'&result='+result+'&_token='+'{{csrf_token()}}';
        }



        $.ajax({
            url: '/index.php/aftersaleUpdateDo',
            type: 'post',
            data: data,
            dataType: 'json',
            async: false,
