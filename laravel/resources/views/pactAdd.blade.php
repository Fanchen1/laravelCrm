...
<div class="x-body">
    <form class="layui-form" id = "form"   >
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="pact_payment" name="pact_payment"  required="" lay-verify="required"
                       autocomplete="off" class="layui-input">
            </div>元
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="pact_totalmoney" name="pact_totalmoney"  required="" lay-verify="required"
                       autocomplete="off" class="layui-input">
            </div>元
        </div>
        <div class="layui-form-item">
