...
<div class="x-body">
    <form class="layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input lay-filter="mem" type="text" class="layui-input" id="test5" placeholder="yyyy-MM-dd HH:mm:ss" name="cost_time" lay-verify="required">
            </div>
        </div>
        <div class="layui-form-item">
    ...
    <div class="layui-input-block">
        <textarea lay-filter="mem" lay-change="" placeholder="请输入内容" id="desc" name="tailorder_contents" class="layui-textarea" lay-verify="required"></textarea>
    </div>
</div>
    <div class="layui-form-item">
