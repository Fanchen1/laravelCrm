...
<script>
    $('[name=add]').on('click',function(){
        ...
        $.ajax({
            url: '/index.php/userAddDo',
            type: 'post',
            data: 'user_name=' + user_name +'&user_tel='+user_tel+'&rank='+rank+'&product='+product+'&user_province='+user_province+'&user_city='+user_city+'&user_area='+user_area+'&user_address='+user_address+'&type='+type+'&source='+source+'&_token=' + '{{csrf_token()}}',
            dataType: 'json',
            async: false,
